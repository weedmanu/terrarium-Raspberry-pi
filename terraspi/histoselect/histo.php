...
session_start(); // pour pouvoir utiliser les sessions
  ...
  if(empty($_POST))
		{
		  $limit = 300;
		  $graphe = 'datamoyh.php';
		  $titre = "<strong>Historique du terrarium des 5 dernières heures </strong><em>(Données lissées, moy / h)</em>";			  
		}
  ...
  if(!empty($_POST))
  {
		...
		if ($graphe == 'data.php') {	
			switch ($limit) {
				case "300":
					$titre = "<strong>Historique du terrarium les 5 dernières heures </strong><em>(Données bruts)</em>";
					break;				
				case "1440":
				...
				switch ($limit) {
					case "300":
						$titre = "<strong>Historique du terrarium  les 5 dernières heures </strong><em>(Données lissées, moy / h)</em>";
						break;
					case "1440":
...
<section>	<!-- corps de page -->	
    ...
    <p>
	   ...
	   <select id="limit" name="limit" >
		   ...
		   <option value="300" <?php if ($limit == 300) { echo 'selected="selected"'; }?> >Les 5 deniéres heures</option>
...
<footer>	<!-- pied de page -->
	...
	<div class="conteneur">       
		...
		<a href="../histo/histo.php" style="text-decoration:none">
		<div class="element" id="bdd">
			<?php require'../admin/bdd.php';?>
		</div> 	</a>
